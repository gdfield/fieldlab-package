classdef (Abstract) Preparation < symphonyui.core.persistent.descriptions.SourceDescription
    ...
    methods
        ...
        function obj = Preparation()
            ...
            obj.addProperty('technique', '', ...
                'type', PropertyType('char', 'row', {'', 'UCSC MEA', 'light sheet', 'patch clamp slice', 'patch clamp whole', 'suction'}),...
                'description', 'measurement technique');
            obj.addProperty('RPE', '', ...
                'type', PropertyType('char', 'row', {'', 'attached', 'isolated'}), ...
                'description', 'state of RPE-retina attachment');
        end
